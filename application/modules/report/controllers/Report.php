    ...
    public function sattendance() {
       ...
       public function student_report() {
        ...
        if ($_POST) {
            ...
            $section_id = $this->input->post('section_id');
            $month = $this->input->post('month');
             $rnop = $this->input->post('registration_no');
            $group = $this->input->post('group');
            $phone = $this->input->post('phone');
            $preadd = $this->input->post('present_address');
            $peradd = $this->input->post('permanent_address');
            ...
            $hmem = $this->input->post('is_hostel_member');
            $discount = $this->input->post('discount');
            $gname = $this->input->post('gname');
            $gphone = $this->input->post('gphone');
            $gpreadd = $this->input->post('gpresent_address');
            $gperadd = $this->input->post('gpermanent_address');
            $gprofession = $this->input->post('gprofession');
            ...
            $this->data['academic_year_id'] = $academic_year_id;
            $this->data['name'] = $name;
             $this->data['registration_no'] = $name;
             $this->data['rno'] = $rnop;
             $this->data['group'] = $group;
             $this->data['phone'] = $phone;
             $this->data['preadd'] = $preadd;
             $this->data['peradd'] = $peradd;
             $this->data['gender'] = $gender;
             $this->data['bgroup'] = $bgroup;
            ...
            $this->data['gname']=$gname ;
             $this->data['gphone']=$gphone ;
            $this->data['gpreadd']= $gpreadd;
            $this->data['gperadd']= $gperadd;
            $this->data['gprofession']=$gprofession ;
            $this->data['grelation']= $grelation;

            $this->data['students'] = $this->report->get_student_listt();
        }



        $this->layout->title($this->lang->line('student') . ' ' . $this->lang->line('attendance') . ' ' . $this->lang->line('report') . ' | ' . SMS);
        $this->layout->view('student_report/index', $this->data);
    }
